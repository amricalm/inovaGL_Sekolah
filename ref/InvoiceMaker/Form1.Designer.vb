...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ReportDataSource2.Value = Me.LineItemBindingSource
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource1)
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource2)
        Me.ReportViewer1.LocalReport.DisplayName = "Invoice"
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "ReportFromGrid.Report1.rdlc"
        ...
        '
        Me.LineItemBindingSource.DataSource = GetType(ReportFromGrid.LineItem)
        '
