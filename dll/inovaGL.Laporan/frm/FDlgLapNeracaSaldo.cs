...
{
    [AdnScObjectAtr("Laporan: Neraca Saldo", "Laporan")]
    public partial class FDlgLapNeracaSaldo : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapNeracaSaldo(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi,DateTime PeriodeMulai, string ThAjar)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil()
        {
            ...
            List<AdnAkun> lst = new AdnAkunDao(this.cnn).GetAll(dateTimePickerDr.Value, dateTimePickerSd.Value, this.PeriodeMulai,this.ThAjar);
            ReportDataSource rds = new ReportDataSource("NeracaSaldo", lst);
