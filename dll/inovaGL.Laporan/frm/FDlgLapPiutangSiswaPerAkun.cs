...
namespace inovaGL.Laporan
{
    ...
    public partial class FDlgLapPiutangSiswaPerAkun : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapPiutangSiswaPerAkun(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi, DateTime PeriodeMulai, string ThAjar)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil(string Kd)
        {
            ...
            lstAkunPiutang = new AdnAkunDao(this.cnn).GetPiutangBiaya();

            DataTable lst = new AdnJurnalDao(this.cnn).GetPiutangPerAkunTabular(this.PeriodeMulai, dateTimePickerDr.Value,KdSekolah,ThAjar);
            ...
            this.namaRPT = "PiutangPerAkun";
            this.rds = rds;
            this.rpm = rpm;
            this.Text = "Piutang Per Kelas";
