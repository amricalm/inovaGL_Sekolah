...
namespace inovaGL.Laporan
{
    ...
    public partial class FDlgLapLRbyDept : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapLRbyDept(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi,string Kd)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil(string Kd)
        {
            ...
            DataTable lst = new inovaGL.Data.AdnLapLabaRugi(this.cnn).CetakByDept("LR",dateTimePickerDr.Value, dateTimePickerSd.Value);
