...
{
    [AdnScObjectAtr("Laporan: Neraca", "Laporan")]
    public partial class FDlgLapNeraca : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapNeraca(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi,DateTime PeriodeAwal, string KdAkunLabaThBerjalan, string ThAjar)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil(string Kd)
        {
            ...
            DataTable lst = new AdnLapNeraca(this.cnn).CetakFormatRincian("NRC", PeriodeAwal, TglDr,this.KdAkunLabaThBerjalan,this.ThAjar );
