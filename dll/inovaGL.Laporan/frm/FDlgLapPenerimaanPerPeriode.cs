...
namespace inovaGL
{
    [AdnScObjectAtr("Laporan: Penerimaan Per Periode", "Laporan")]
    public partial class FDlgLapPenerimaanPerPeriode : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapPenerimaanPerPeriode(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi, string AppName,DateTime PeriodeMulai)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil()
        {
            ...
            else
            {
                ...
                DataTable lst = new AdnJurnalDao(this.cnn).GetLapPengeluaranPerSumberDana(dateTimePickerTglDari.Value, dateTimePickerTglSampai.Value, Project, KdAkun,Dept);
                ...
                this.namaRPT = "PenerimaanPerPeriode";
                this.rds = rds;
                this.rpm = rpm;
                this.Text = "Penerimaan Per Periode";
