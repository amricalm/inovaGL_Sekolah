...
namespace inovaGL.Laporan
{
    ...
    public partial class FDlgLapPiutangSiswaPerKelas : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapPiutangSiswaPerKelas(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi, DateTime PeriodeMulai, string ThAjar)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil(string Kd)
        {
            ...
            DataTable lst = new AdnJurnalDao(this.cnn).GetPiutangPerSiswaPerAkunTabular(this.PeriodeMulai, dateTimePickerDr.Value, KdSekolah, ThAjar,Kelas);
            ...
            this.namaRPT = "PiutangPerAkunPerSiswa";
            this.rds = rds;
            this.rpm = rpm;
