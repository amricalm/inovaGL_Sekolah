...
namespace inovaGL.Laporan
{
    ...
    public partial class FDlgLapBukuBesar : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapBukuBesar(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi,string Kd)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil(string Kd)
        {
            ...
            DataTable lst = new AdnJurnalDao(this.cnn).GetLapBukuBesar(dateTimePickerDr.Value, dateTimePickerSd.Value,KdProject,"");
