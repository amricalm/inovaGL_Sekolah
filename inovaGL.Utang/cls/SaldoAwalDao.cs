...
namespace inovaGL.Utang
{
    public class AdnSaldoAwalDao
    {
        ...
        private const string NAMA_TABEL = "ac_saldo_utang_siswa";
        ...
        public DataTable Get(int KdSiswa, string ThAjar, DateTime PerTgl)
        {
            ...
            try
            {
                ...
                + "     FROM ac_saldo_utang_siswa hdr "
                + "     INNER JOIN ac_saldo_utang_siswa_dtl dtl "
        ...
        public DataTable GetRincian(string KdSaw)
        {
            ...
            try
            {
                string sql =
                " select bs.kd_biaya, nm_biaya, isnull(jmh,0) jmh, item_bulan, ket"
                + "     , kd_akun_kewajiban, kd_akun_pendapatan "
                + " from  ms_biaya bs "
                + " LEFT OUTER JOIN "
                + " ( "
                + "     SELECT kd_biaya, jmh, item_bulan,ket "
