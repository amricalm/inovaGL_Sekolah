...
namespace inovaGL.Utang
{
    ...
    public partial class FTSaldoUtangSiswa : Form
    {
        ...
        public FTSaldoUtangSiswa(SqlConnection cnn, string AppName, AdnScPengguna Pengguna, string KdSekolah,string ThAjar, string KdAkunPenyeimbangSaw, DateTime PeriodeMulai)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void FillDataGridView(string KdSaw)
        {
            ...
            bs.DataSource = null;
            bs.DataSource = new inovaGL.Utang.AdnSaldoAwalDao(this.cnn).GetRincian(KdSaw);
            dgv.DataSource = bs;
        ...
        private void Simpan()
        {
            ...
            if (this.IsValid())
            {
                ...
                if (new inovaGL.Utang.AdnSaldoAwalDao(this.cnn).Get(KdSiswa, ThAjar))
                {
                ...
                {
                    //--- Header SAW
                    inovaGL.Utang.AdnSaldoAwal o = new inovaGL.Utang.AdnSaldoAwal();
                    ...
                    Jurnal.KdJurnal = "";
                    Jurnal.Deskripsi = "Jurnal Utang/Kewajiban Siswa [Saldo Awal]";
                    ...
                    foreach (DataGridViewRow baris in dgv.Rows)
                    {
                        if (AdnFungsi.CDec(baris.Cells["Jmh"]) > 0)
                        {
                            ...
                            JurnalDtl.Memo = "Saldo Awal Utang/Kewajiban Per Siswa";
                    ...
                    try
                    {
                        ...
                        inovaGL.Utang.AdnSaldoAwalDao dao = new inovaGL.Utang.AdnSaldoAwalDao(this.cnn, this.Pengguna, Trans);
        ...
        private void comboBoxKelas_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBoxKelas.SelectedIndex > -1)
            {
                ...
                bsSiswa.DataSource = new inovaGL.Utang.AdnSaldoAwalDao(this.cnn).GetRingkasan(Kelas, this.ThAjar, this.KdSekolah, dateTimePickerTgl.Value);
                dgvSiswa.DataSource = bsSiswa;
        ...
        private void buttonSalin_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //{
                //    MessageBox.Show("Jumlah Utang/Kewajiban = 0 (Nol)!", this.AppName, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                //}
                //else
                //{
                if (comboBoxSekolah.SelectedIndex > -1)
                {
                    ...
                    foreach (DataGridViewRow Baris in dgv.Rows)
                    {
                        ...
                        bs.oBiaya.KdAkunKewajiban = AdnFungsi.CStr(Baris.Cells["KdAkunKewajiban"]);
                        lst.Add(bs);
                    }

                    int KdSiswa = AdnFungsi.CInt(dgvSiswa.CurrentRow.Cells["KdSiswa"], true);
                    FProsesSalinSaldoUtangSiswa ofm = new FProsesSalinSaldoUtangSiswa(this.cnn, this.AppName, this.Pengguna, KdSekolah, this.ThAjar, lst, KdSiswa, textBoxNmSiswa.Text,this.KdAkunPenyeimbangSaw, this.PeriodeMulai);
                    ofm.ShowDialog();
                }
                else
                {
        ...
        private void FTSaldoUtangSiswa_Load(object sender, EventArgs e)
        {
