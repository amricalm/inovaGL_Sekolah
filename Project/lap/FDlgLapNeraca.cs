...
namespace inovaGL
{
    ...
    public partial class FDlgLapNeraca : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapNeraca(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi,string Kd)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void Tampil(string Kd)
        {
            ...
            DataTable lst =  new AdnLapNeraca(this.cnn).Cetak(4,new DateTime(2010,1,1),12,2011);
