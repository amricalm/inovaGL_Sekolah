...
namespace inovaGL
{
    [AdnScObjectAtr("Laporan: Neraca Percobaan", "Laporan")]
    public partial class FDlgLapNeracaPercobaan : Andhana.AdnBaseForm
    {
        ...
        public FDlgLapNeracaPercobaan(SqlConnection cnn, string ReportPath, string ReportExt, string Organisasi,string Kd)
        {
            InitializeComponent();
            this.cnn = cnn;
