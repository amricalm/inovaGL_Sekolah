...
namespace inovaPOS
{
    class AdnMutasiMasukDtlDao
    {
        private const short JUMLAH_KOLOM = 6;
        private const string NAMA_TABEL = "ac_tmutasi_masuk_dtl";
        ...
        public AdnMutasiMasukDtlDao(SqlConnection cnn)
        {
            this.cnn = cnn;
            this.cmd = new SqlCommand("", this.cnn);
        }
        private void SetFldNilai(AdnMutasiMasukDtl o)
        {
            short idx = 0;
        ...
        public void Simpan(AdnMutasiMasukDtl o)
        {
            this.SetFldNilai(o);
        ...
        public void Update(AdnMutasiMasukDtl o)
        {
            this.SetFldNilai(o);
        ...
        public List<AdnMutasiMasukDtl> GetByNoFaktur(string kd)
        {
            List<AdnMutasiMasukDtl> lst = new List<AdnMutasiMasukDtl>();
            string sql =
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    AdnMutasiMasukDtl o = new AdnMutasiMasukDtl();
        ...
        public List<AdnMutasiMasukDtl> GetAll()
        {
            List<AdnMutasiMasukDtl> lst = new List<AdnMutasiMasukDtl>();
            string sql =
