...
namespace inovaPOS
{
    [AdnScObjectAtr("Form: Daftar Mutasi Masuk Gudang", "Mutasi Masuk")]
    public partial class FDTMutasiMasuk : Form
    {
        private SqlConnection cnn;
        private string AppName;
        BindingSource bs = new BindingSource();
        public FDTMutasiMasuk(SqlConnection cnn, string AppName)
        {
            InitializeComponent();
            this.cnn = cnn;
        ...
        private void FDTMutasiMasuk_Load(object sender, EventArgs e)
        {
        ...
        private void FillDataGridView()
        {
            ...
            bs.DataSource = new AdnMutasiMasukDao(this.cnn).GetByArgs(dateTimePickerDr.Value, dateTimePickerSd.Value,sPemasok);
            dgv.DataSource = bs;
        ...
        {
            FTMutasiMasuk ofm = new FTMutasiMasuk(this.cnn,this.AppName, AdnModeEdit.BARU, "", this);
            ofm.ShowDialog();
        }
        ...
        private void Pilih()
        {
            ...
            FTMutasiMasuk ofm = new FTMutasiMasuk(this.cnn,this.AppName,  AdnModeEdit.BACA, dgv.CurrentRow.Cells["no_faktur"].Value.ToString(), this);
            ofm.ShowDialog();
