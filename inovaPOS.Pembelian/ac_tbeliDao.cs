...
namespace inovaPOS
{
    public class AdnBeliDao
    {
        private const short JUMLAH_KOLOM = 7;
        private const string NAMA_TABEL = "ac_tbeli";
        ...
        public AdnBeliDao(SqlConnection cnn)
        {
            this.cnn = cnn;
            this.cmd = new SqlCommand("", this.cnn);
        }
        private void SetFldNilai(AdnBeli o)
        {
            short idx = 0;
        ...
        public AdnBeli Get(string kd)
        {
            ...
            try
            {
                ...
                if (o != null)
                {
                    o.item_df = new AdnBeliDtlDao(this.cnn).GetByNoFaktur(o.no_faktur);
                }
            }
            catch (DbException exp)
            {
        ...
        public List<AdnBeli> GetAll()
        {
            List<AdnBeli> lst = new List<AdnBeli>();
            string sql =
            " select no_faktur, tgl, kd_ps, ket, kd_term, diskon, biaya_kirim"
        ...
        public List<AdnBeli> GetByPeriode(DateTime TglDr, DateTime TglSd)
        {
            List<AdnBeli> lst = new List<AdnBeli>();
            string sql =
            " select no_faktur, tgl, kd_ps, ket, kd_term, diskon, biaya_kirim "
        ...
        {
            DataTable tbl = new DataTable("ac_tbeli");
            DataRow row;
